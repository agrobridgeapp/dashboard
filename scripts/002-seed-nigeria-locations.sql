-- AgroBridge Nigeria Location Seed
-- Migration 002: All 36 states + FCT, all 774 LGAs
-- Source: Official Nigerian government LGA listing
...
-- Abia (17 LGAs)
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
...
]) FROM states WHERE name = 'Abia' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Adamawa' ON CONFLICT (state_id, name) DO NOTHING;
...
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  ...
  'Nsit Ubium','Obot Akara','Okobo','Onna','Oron','Oruk Anam','Ukanafun',
  'Udung Uko','Uruan','Urue Offong/Oruko','Uyo'
]) FROM states WHERE name = 'Akwa Ibom' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Anambra' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Bauchi' ON CONFLICT (state_id, name) DO NOTHING;

-- Bayelsa (8 LGAs)
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  'Brass','Ekeremor','Kolokuma/Opokuma','Nembe','Ogbia','Sagbama',
  'Southern Ijaw','Yenagoa'
]) FROM states WHERE name = 'Bayelsa' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Benue' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Borno' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Cross River' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Delta' ON CONFLICT (state_id, name) DO NOTHING;

-- Ebonyi (13 LGAs)
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  'Abakaliki','Afikpo North','Afikpo South','Ebonyi','Ezza North',
  'Ezza South','Ikwo','Ishielu','Ivo','Izzi','Ohaozara','Ohaukwu','Onicha'
]) FROM states WHERE name = 'Ebonyi' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Edo' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Ekiti' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Enugu' ON CONFLICT (state_id, name) DO NOTHING;

-- FCT - Abuja (6 LGAs)
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  'Abaji','Abuja Municipal','Bwari','Gwagwalada','Kuje','Kwali'
]) FROM states WHERE name = 'FCT - Abuja' ON CONFLICT (state_id, name) DO NOTHING;

-- Gombe (11 LGAs)
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  'Akko','Balanga','Billiri','Dukku','Funakaye','Gombe','Kaltungo',
  'Kwami','Nafada','Shongom','Yamaltu/Deba'
]) FROM states WHERE name = 'Gombe' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Imo' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Jigawa' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Kaduna' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Kano' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Katsina' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Kebbi' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Kogi' ON CONFLICT (state_id, name) DO NOTHING;
...
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  ...
  'Oyun','Pategi'
]) FROM states WHERE name = 'Kwara' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Lagos' ON CONFLICT (state_id, name) DO NOTHING;

-- Nasarawa (13 LGAs)
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  'Akwanga','Awe','Doma','Karu','Keana','Keffi','Kokona','Lafia',
  'Nasarawa','Nasarawa Egon','Obi','Toto','Wamba'
]) FROM states WHERE name = 'Nasarawa' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Niger' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Ogun' ON CONFLICT (state_id, name) DO NOTHING;
...
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  ...
  'Ose','Owo'
]) FROM states WHERE name = 'Ondo' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Osun' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Oyo' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Plateau' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Rivers' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Sokoto' ON CONFLICT (state_id, name) DO NOTHING;
...
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  ...
  'Wukari','Yorro','Zing'
]) FROM states WHERE name = 'Taraba' ON CONFLICT (state_id, name) DO NOTHING;
...
]) FROM states WHERE name = 'Yobe' ON CONFLICT (state_id, name) DO NOTHING;
...
INSERT INTO lgas (state_id, name) SELECT id, unnest(ARRAY[
  ...
  'Tsafe','Zurmi'
]) FROM states WHERE name = 'Zamfara' ON CONFLICT (state_id, name) DO NOTHING;
