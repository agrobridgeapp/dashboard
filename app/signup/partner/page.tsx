...
import { AlertCircle, Loader2, Tractor, Eye, EyeOff, CheckCircle2 } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user && data.token) {
        localStorage.setItem("agrobridge_user", JSON.stringify(data.user))
        localStorage.setItem("agrobridge_token", data.token)
      }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-lg">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-balance">Create Your Partner Account</h1>
          <p className="text-muted-foreground mt-1">
            Get steady jobs and guaranteed payments every season
          </p>
        </div>
        ...
        <Card>
          <CardHeader className="pb-4">
            ...
            <CardDescription>You'll set up your service offerings after signing up</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="companyName" value={formData.companyName} onChange={(e) => updateField("companyName", e.target.value)} placeholder="Your business name (optional)" />
              </div>
